...
const bufferStream = __nccwpck_require__(1742);
...
const normalizeUrl = __nccwpck_require__(914);
const getStream = __nccwpck_require__(4982);
const CachePolicy = __nccwpck_require__(5541);
const Response = __nccwpck_require__(7959);
const lowercaseKeys = __nccwpck_require__(1743);
const cloneResponse = __nccwpck_require__(9281);
const Keyv = __nccwpck_require__(8492);
...
const mimicResponse = __nccwpck_require__(8457);
...
const { promisify } = __nccwpck_require__(3837)
const JSONB = __nccwpck_require__(447)
const zlib = __nccwpck_require__(9796)

const mergeOptions = __nccwpck_require__(6416)
...
const zlib = __nccwpck_require__(9796);
const mimicResponse = __nccwpck_require__(7670);
...
const QuickLRU = __nccwpck_require__(476);
const delayAsyncDestroy = __nccwpck_require__(4186);
...
const resolveALPN = __nccwpck_require__(4103);
const QuickLRU = __nccwpck_require__(476);
const {Agent, globalAgent} = __nccwpck_require__(4485);
const Http2ClientRequest = __nccwpck_require__(7278);
const calculateServerName = __nccwpck_require__(6830);
const delayAsyncDestroy = __nccwpck_require__(4186);
...
const {Agent, globalAgent} = __nccwpck_require__(4485);
const IncomingMessage = __nccwpck_require__(1227);
const proxyEvents = __nccwpck_require__(9048);
const {
	ERR_INVALID_ARG_TYPE,
	ERR_INVALID_PROTOCOL,
	ERR_HTTP_HEADERS_SENT
} = __nccwpck_require__(6249);
const validateHeaderName = __nccwpck_require__(7706);
const validateHeaderValue = __nccwpck_require__(8371);
const proxySocketHandler = __nccwpck_require__(1015);
...
const {
	Agent,
	globalAgent
} = __nccwpck_require__(4485);
const ClientRequest = __nccwpck_require__(7278);
const IncomingMessage = __nccwpck_require__(1227);
const auto = __nccwpck_require__(5433);
const {
	HttpOverHttp2,
	HttpsOverHttp2
} = __nccwpck_require__(741);
const Http2OverHttp2 = __nccwpck_require__(6994);
const {
	Http2OverHttp,
	Http2OverHttps
...
const http = __nccwpck_require__(3685);
const https = __nccwpck_require__(5687);
const JSStreamSocket = __nccwpck_require__(3638);
const {globalAgent} = __nccwpck_require__(4485);
const UnexpectedStatusCodeError = __nccwpck_require__(7508);
const initialize = __nccwpck_require__(6319);
const getAuthorizationHeaders = __nccwpck_require__(4666);
...
const http = __nccwpck_require__(3685);
const https = __nccwpck_require__(5687);
const Http2OverHttpX = __nccwpck_require__(5087);
const getAuthorizationHeaders = __nccwpck_require__(4666);
...
const {Agent} = __nccwpck_require__(4485);
const JSStreamSocket = __nccwpck_require__(3638);
const UnexpectedStatusCodeError = __nccwpck_require__(7508);
const initialize = __nccwpck_require__(6319);
...
// eslint-disable-next-line node/prefer-global/url
const {URL} = __nccwpck_require__(7310);
const checkType = __nccwpck_require__(8188);
...
const {ERR_HTTP2_NO_SOCKET_MANIPULATION} = __nccwpck_require__(6249);
...
const {ERR_INVALID_HTTP_TOKEN} = __nccwpck_require__(6249);
const isRequestPseudoHeader = __nccwpck_require__(4285);
...
const EventEmitter = __nccwpck_require__(2361);
const JSONB = __nccwpck_require__(447);
const compressBrotli = __nccwpck_require__(788);
...
const lowercaseKeys = __nccwpck_require__(5063);
...
/* harmony import */ var got__WEBPACK_IMPORTED_MODULE_0__ = __nccwpck_require__(8275);
...
closeIssue(input: {issueId: \"${issueID}\"}) {
  ...
  let rply = got__WEBPACK_IMPORTED_MODULE_0__/* ["default"].post */ .ZP.post(endpoint, options).json();
};
...
while (runner) {
  ...
  let data = await got__WEBPACK_IMPORTED_MODULE_0__/* ["default"].post */ .ZP.post(endpoint, options).json();
  // console.log(data);
  let nextPage =
...
var source = __nccwpck_require__(258);
...
var src = __nccwpck_require__(2841);
// EXTERNAL MODULE: ./node_modules/decompress-response/index.js
var decompress_response = __nccwpck_require__(8995);
...
var cacheable_lookup_source = __nccwpck_require__(1590);
// EXTERNAL MODULE: ./node_modules/http2-wrapper/source/index.js
var http2_wrapper_source = __nccwpck_require__(5416);
...
/******/ var __webpack_exports__ = __nccwpck_require__(4224);
